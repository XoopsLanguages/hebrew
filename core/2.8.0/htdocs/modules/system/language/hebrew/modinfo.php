...
//2.8.0
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES', 'הפעלת ניהול שפות');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES_DESC', 'נהלו את רישום השפות, חבילות השפה, בדיקות התקינות ודריסות התרגום של האתר.');
define('_MI_SYSTEM_BNAME14', 'מחליף שפה');
